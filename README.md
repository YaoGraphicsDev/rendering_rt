# DDGI
A basic implementation based on the 2019 DDGI paper[^1]. Accounts for only the diffuse components.
...
Notice the pixel perfect shadows, which is a signature visual cue of ray queries. Also notice the heavy moiré patterns caused by the lack of mipmapping. Since I’ll be averaging the radiance later in the process, these artifacts won’t matter.
...
[^1]: [Dynamic Diffuse Global Illumination with Ray-Traced Irradiance Fields](https://jcgt.org/published/0008/02/01/)